...
fit
# beta[1]     -1.38    0.00 0.05    -1.48    -1.41    -1.38    -1.35    -1.28  1127    1
# beta[2]      0.01    0.00 0.01     0.00     0.01     0.01     0.01     0.02 19429    1
# beta[3]     -0.42    0.00 0.01    -0.44    -0.43    -0.42    -0.41    -0.40 19031    1
# beta[4]     -0.15    0.00 0.07    -0.29    -0.20    -0.15    -0.10     0.00  2270    1
# beta[5]      0.56    0.00 0.06     0.45     0.52     0.56     0.60     0.67  1357    1
# beta[6]      1.21    0.00 0.06     1.10     1.17     1.21     1.25     1.33  1395    1
# beta[7]      0.28    0.00 0.06     0.17     0.25     0.28     0.32     0.40  1390    1
# beta[8]      1.14    0.00 0.06     1.03     1.11     1.14     1.18     1.26  1409    1
# beta[9]      0.22    0.00 0.06     0.09     0.17     0.22     0.26     0.35  1792    1
# beta[10]    -0.39    0.00 0.06    -0.50    -0.43    -0.39    -0.35    -0.27  1365    1
# beta[11]     0.48    0.00 0.08     0.33     0.43     0.48     0.54     0.64  2443    1
# beta[12]     0.42    0.00 0.06     0.30     0.38     0.42     0.46     0.54  1462    1
# ....
#
#
...
colnames(params.mat)
dim(X)
# beta1   <- params.mat$beta.1.
# beta2   <- params.mat$beta.2.
# beta3   <- params.mat$beta.3.
# beta4   <- params.mat$beta.4.
# head(stops.dat)
