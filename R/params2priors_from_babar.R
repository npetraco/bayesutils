...
# Generate samples from the Half Cauchy prior
# u: Input scalar/vector of values between 0 and 1
# scale: The scale parameter of the distribution
HalfCauchyPrior <- function(u, scale) {
  return(qhcauchy(u, sigma = scale))
}
